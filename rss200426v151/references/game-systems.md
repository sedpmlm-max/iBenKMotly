...
- **Curse** (range: same region + adjacent 1 region) — on curse, victim EP → 0. Whisper arrives with a question. Correct answer → EP fully restored. Timeout/bot detection → EP stays 0. See combat-items.md § Guardians for full EP table.
